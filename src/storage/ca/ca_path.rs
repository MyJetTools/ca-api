...
impl CaDataPath {
    ...
    pub fn to_ca_cert_file_name(&self) -> String {
        self.clone().into_file_name(CA_CERT_FILE_NAME)
    }

    pub fn to_ca_private_key_file_name(&self) -> String {
        self.clone().into_file_name(CA_PRIVATE_KEY_FILE_NAME)
    }

    pub fn to_serial_file_name(&self) -> String {
        self.clone().into_file_name(SERIAL_FILE_NAME)
    }

    pub fn to_crl_file_name(&self) -> String {
        self.clone().into_file_name(CRL_FILE_NAME)
    }
}
